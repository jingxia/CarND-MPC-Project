      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          ...
          */
          ...
          Eigen::Map<Eigen::VectorXd> waypoints_x_eigen(ptrx, 8);
          Eigen::Map<Eigen::VectorXd> waypoints_y_eigen(ptry, 8);

          Eigen::VectorXd coeffs = polyfit(waypoints_x_eigen, waypoints_y_eigen, 4);
          //
          double cte = coeffs[0];
